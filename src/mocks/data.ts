...
export const merchants: Merchant[] = [
  { id: 'm1', name: 'Café Aroma', location: 'Hulhumalé' },
  { id: 'm2', name: 'Island Resort Group', location: 'Baa Atoll' },
  { id: 'm3', name: 'Novelty Traders', location: 'Malé' },
